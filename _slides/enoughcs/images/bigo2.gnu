...
set style line 9 lc rgb '#ff00ff' lt 1 lw 3

set style fill pattern 1

plot [0:10][0:100] '+' using 1:(q($1)) notitle with filledcurves above lc rgb '#999999', \
                   q(x) title '' with lines linestyle 9, \
