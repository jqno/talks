...
# Building a<br/>Bullshit Language { data-state="page-title" data-background-image="../images/jfall-background.jpg" }

<!-- markdownlint-disable MD003 MD033 MD045 -->

![](../images/jfall2024.png){ style="height:240px;" }
...
## Jan Ouwens { data-state="page-title" data-background-image="../images/jfall-background.jpg" }
...
# { data-state="page-title" data-background-image="../images/jfall-background.jpg" }
...
## Questions? { data-state="page-title" data-background-image="../images/jfall-background.jpg" }
...
| [background](/talks/slides/bullshitlanguage/images/jfall-background.jpg) | by Jan Ouwens |
